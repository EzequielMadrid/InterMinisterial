...
export async function createPost(content: string, image: string) {
  try {
    ...
    revalidatePath("/"); // purge the cache for the forum
...
export async function toggleLike(postId: string) {
  try {
    ...
    // console.error("No se pudo cambiar el estado del me gusta:", error);
    return {
      success: false,
      error: "No se pudo cambiar el estado del me gusta",
    };
  }
}
...
export async function createComment(postId: string, content: string) {
  try {
    ...
    return { success: false, error: "No se pudo crear el comentario" };
  }
}
